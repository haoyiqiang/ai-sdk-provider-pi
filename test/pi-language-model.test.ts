...
function createModelOptions(overrides?: Partial<PiLanguageModelOptions>): PiLanguageModelOptions {
  return {
...
vi.mock('@earendil-works/pi-coding-agent', () => {
  ...
  return {
    createAgentSession: vi.fn(() => {
      if (!mockSessionResult) throw new Error('No mock session configured');
  ...
  describe('doGenerate', () => {
    ...
    it('returns text content from agent response', async () => {
      ...
      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'text_delta', contentIndex: 0, delta: 'Hi there!', partial: {} as any },
      });
    ...
    it('returns reasoning content from thinking', async () => {
      ...
      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'thinking_delta', contentIndex: 0, delta: 'Let me think...', partial: {} as any },
      });

      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'text_delta', contentIndex: 1, delta: 'My answer', partial: {} as any },
      });
    ...
    it('returns tool call content', async () => {
      ...
      mockSession.emitEvent({
        ...
        assistantMessageEvent: {
          type: 'toolcall_end',
          contentIndex: 0,
          toolCall: { id: 'tc_1', name: 'read', arguments: { path: '/tmp/test.txt' } },
          partial: {} as any,
        },
      });
  ...
  describe('doStream', () => {
    ...
    it('streams text deltas', async () => {
      ...
      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'text_delta', contentIndex: 0, delta: 'Hi ', partial: {} as any },
      });

      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'text_delta', contentIndex: 0, delta: 'there!', partial: {} as any },
      });

      mockSession.emitEvent({
        type: 'message_update',
        message: {} as any,
        assistantMessageEvent: { type: 'text_end', contentIndex: 0, content: 'Hi there!', partial: {} as any },
      });
