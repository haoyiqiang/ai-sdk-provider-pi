...
vi.mock('@earendil-works/pi-ai', () => {
  ...
  return {
    getModel: vi.fn((provider: string, modelId: string) => {
      const registry: Record<string, Record<string, ReturnType<typeof mockModel>>> = {
        anthropic: {
          'claude-sonnet-4': mockModel('claude-sonnet-4', 'anthropic', 'Claude Sonnet 4'),
          'claude-opus-4': mockModel('claude-opus-4', 'anthropic', 'Claude Opus 4'),
          'claude-haiku-4': mockModel('claude-haiku-4', 'anthropic', 'Claude Haiku 4'),
        },
        openai: {
        ...
        google: {
          'gemini-2.5-pro': mockModel('gemini-2.5-pro', 'google', 'Gemini 2.5 Pro'),
        },
      };
